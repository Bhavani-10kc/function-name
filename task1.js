...
function showmessage(){
 console.log(`"Hello,welcome to the websites!"`);
}
showmessage();
...
function countDown(){
var  j=5;
for(var j=5;j>=1;j--){console.log(j)
}}countDown()
